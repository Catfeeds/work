...
<body>
  ...
  <section class="main hide">
    ...
    <div class="choose" style="position: relative;">
      <a class="btn" data-href="17657" href="http://m.quyundong.com/court/detail?id=17657&cid=1">利华羽毛球会馆</a>
      <a class="btn" data-href="17652" href="http://m.quyundong.com/court/detail?id=17652&cid=1">大奥羽乒馆</a>
      <div style="width:0.3rem;height:0.33rem;position:absolute;top:0.7rem;left:2.4rem;"><img src="/static/act/one_beijing/images/touch.png" style="width:100%;"></div>
    </div>
    ...
    <div class="note">
      <ul>
        ...
        <li>4. 适用于趣运动（天津）任何页面内下单并指定的2个球馆：利华羽毛球会馆、大奥羽乒馆</li>
    </div>
  </section>
