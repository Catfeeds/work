;(function(_title,_desc,_imgUrl){
  ...
  var shareImgUrl = 'http://' + window.location.host + _imgUrl;
  console.log(_title,_desc,_imgUrl);
  //微信config用
  ...
  //   }else{return true}
  // }
})(document.getElementById('_title').value,document.getElementById('_desc').value,document.getElementById('_imgUrl').value)
