<template>
  <div id="wrapper">
    ...
    <section id="loading" class="loading" :class="{ 'hide' : loadingHide }" data-venue-id='{{ venuesId }}'>
      <div class="loading-icon" style="background-image:url(/static/vue-h5-signup/images/loading.png)"></div>
    </section>
    <!-- main view -->
    <router-view
      class="view"
...
export default {
  ...
  data () {
    return {
      ...
      shareImgUrl:window.location.origin + '/static/vue-h5-signup/images/badmintonshare.jpg',
      wxtitle:"羽林争霸 等你来挑战！",
      wxdesc:"报名参加趣运动杯奥体站羽毛球联赛，与高手过招，挑战自己！"
    }
  },
  computed:{
    enURL(){
