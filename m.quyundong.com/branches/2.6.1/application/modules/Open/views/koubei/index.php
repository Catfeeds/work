...
?>
          <li><a href="book?cid=<?php echo $booking['cat_id']?>&t=<?php echo $list['book_date'];?>" <?php echo $is_disabled;?> class="borderBottom1px"> <span><?php echo $list['courses_date'];?><em></em></span><b><strong>¥<?php echo floatval($booking['price']);?></strong>起</b><i></i></a></li>
<?php
  }
