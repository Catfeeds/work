...
class api_Order extends api_Base
{
	 ...
	 */
	public static function confirmGoodsOrder($param){
		$param['action']	= 'confirm_order_goods';
		$param['order_type'] = 14;
		$param = self::addPublicParam($param, self::ORDER_API_KEY);
		$url = self::OrderApiUrl.http_build_query($param);
		return self::request($url, self::LOGTITLE);
	 ...
	 * @return [type]        [description]
	 */
	public static function insertGoodsOrder($param){
		$param['action']	= 'insert_order_goods';
