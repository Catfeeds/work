...
<link href="/themes/qu202/css/user.css" type="text/css" rel="stylesheet">
    ...
    <div class="user-main" style="min-height:90vh;">
      ...
      <!-- 顶部栏end -->
      <!-- 头像和余额卡券 -->
      <div class="face decathlon borderBottom1px">
        ...
        <div class="info">
          <div class="user-money" onclick="window.location.href='<?= baf_CHtml::createUrl('/user/balance');?>'"> <span>余额</span><br><span class="sp"><?php echo isset($homeInfo['money']) ? $homeInfo['money'] : 0?> 元</span></div>
          <div class="user-card" onclick="window.location.href='<?= baf_CHtml::createUrl('/Coupon/Index');?>'"  style="width:49%;"> <span>卡券</span><br><span class="sp"><?php echo isset($homeInfo['coupon_number']) ? $homeInfo['coupon_number'] : 0?> 张可用</span></div>
        </div>
      </div>
      <!-- 头像和余额卡券end -->
      <!-- 其他信息 -->
  ...
  <?php if (isset($msgCount[2]) && $msgCount[2])  { ?>
    ...
    <div class="user-order borderBottom1px" onclick="window.location.href='<?= baf_CHtml::createUrl('/myorder');?>'">
      ...
      <div style="margin-top:0;" class="user-more borderBottom1px">
        <a href="<?= baf_CHtml::createUrl('/Coupon/Index');?>" class="user-vip-card borderBottom1px">
          <div class="icon-right"><img data-src="/themes/qu202/images/user/icon-right.png"></div>
          <div class="icon-vip-card"><img data-src="/themes/decathlon/images/mycard.png"></div><span>我的卡券</span>
        </a>
      ...
      <?php } ?>
      <!-- 会员卡和我的收藏end -->
      <a href='https://www.decathlon.com.cn/zh/store-locator' class="user-shop borderBottom1px borderTop1px">
        <div class="user-shop-decathlon">
          <div class="icon-right"><img data-src="/themes/qu202/images/user/icon-right.png"></div>
          <div class="icon-telephone"><img data-src="/themes/decathlon/images/shop.png"></div><span>附近的迪卡侬商场</span>
        </div>
      </a>
      <!-- 联系客服 -->
      ...
      <div class="user-shop borderBottom1px borderTop1px">
        <a href="https://www.decathlon.com.cn/zh?utm_source=GoSports&utm_medium=social&utm_campaign=hp"><img src="/themes/decathlon/images/decathlon_banner.gif"></a>
      </div>
