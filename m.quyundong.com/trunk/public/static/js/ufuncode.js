		...
		wx.ready(function(){
		    ...
		    wx.onMenuShareTimeline({
		        title: '0元抢码，豪车订场任你爽！抢一码，享70，新用户就可以那么任性哦～', // 分享标题
		        link: myURL, // 分享链接
		        imgUrl: 'http://m.quyundong.com/static/images/ufuncodesharen.jpg', // 分享图标
		        success: function () { 
		            // 用户确认分享后执行的回调函数
		            // alert("success");
		            console.log("success");
		    ...
		    wx.onMenuShareAppMessage({
		        title: '0元抢码，豪车订场任你爽！', // 分享标题
		        desc: '抢一码，享70，新用户就可以那么任性哦～', // 分享描述
		        link: myURL, // 分享链接
		        imgUrl: 'http://m.quyundong.com/static/images/ufuncodesharen.jpg', // 分享图标
		...
		function wxConfigToken (url){
			...
			var url = url;
			console.log(url);
			xhr.open('get', 'http://m.quyundong.com/activity/GetWeixinToken/?url='+url
				);
