function ShowWait (okCallback,cancelCallback,opt) {
  this.opt = opt || {}
  this.coverStyleDisplayNone = 'position: fixed;z-index:999999999;top:0;left:0;bottom:0;right:0;background-color: rgba(0,0,0,0.3);display:none;'
  this.coverStyleDisplayBlock = 'position: fixed;z-index:999999999;top:0;left:0;bottom:0;right:0;background-color: rgba(0,0,0,0.3);display:block;'
...
ShowWait.prototype.init = function() {
  ...
  this.msgbox.innerHTML = this.opt.title || '确认操作？'
  this.cancel.innerHTML = this.opt.leftBtnText ||  '取消'
  this.ok.innerHTML = this.opt.rightBtnText || '确定'
...
ShowWait.prototype.createComfirm = function () {
  ...
  div.setAttribute('style','width: 60%;background-color: #fff;border-radius: 6px;overflow: hidden;padding-top:1em;margin:200px auto;')
  return div
}
...
ShowWait.prototype.createMsgbox = function () {
  ...
  div.setAttribute('style','width: 100%;line-height: 1.3;border-bottom: 1px solid #eee;padding-bottom: 0.8em;')
  return div
}
