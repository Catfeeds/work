...
<script>
    ...
    var goodsOrderStatus = <?php echo json_encode($goodsOrderStatus);?>;
	        ...
	        var callback = function(res) {
	            ...
	            for (var i = 0; i < res.data.length; i++) {
                    ...
                    if(res.data[i].order_status == 5){
	                    ...
	                    oStatus = res.data[i].order_type==14 ? goodsOrderStatus[parseInt(res.data[i].order_status)] : orderStatus[parseInt(res.data[i].order_status)];
                    }
                    ...
                    if(res.data[i].order_type==14){
                        str = str + '<div class="order-item">' + '<a href='+href+'>' + '<ul class="info-list">' + '<li class="bdline">' + '<span class="order_status">' + oStatus + '</span>' + '<p style="text-align:left;color:#636363;height:20px;overflow:hidden;"><img src="' + res.data[i].order_icon + '" width="16">' + res.data[i].order_title + '</p>' + '</li>' + '<li>' + '<div class="flw">' + '<p class="t">购买数量:</p>' + '<p class="c">' + res.data[i].goods_number + '</p>' + '</div>' + '<div class="frw"></div>' + '</li>' + '<li>' + '<div class="flw">' + '<p class="t">订单金额:</p>' + '<p class="c">' + amount + '</p>' + '</div>' + '<div class="frw"></div>' + '</li>' + '</ul>' + '</a>'+cancelPay+ '</div>';
                    }else{
