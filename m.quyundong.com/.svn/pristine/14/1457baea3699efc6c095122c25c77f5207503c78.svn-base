$(document).ready(function() {
  ...
  Slider.prototype.popIndex = function(n) {
    var idx = this.idx;
    ...
    lis[cidx-1] && (lis[cidx-1].style.webkitTransition = '');
    lis[cidx+1] && (lis[cidx+1].style.webkitTransition = '');
    ...
    for (var i = 0; i < lis.length; i++) {
      var diff = i - cidx;
      lis[i].style.webkitTransform = 'translate3d('+ (this.scaleW * diff) +'px, 0, 0)';
    };
  };

  Slider.prototype.reset = function() {
    var lis = this.outer.querySelectorAll('li');
    var len = lis.length;
    for (var i = 0; i < lis.length; i++) {
      lis[i].style.webkitTransform = 'translate3d('+ i*this.scaleW +'px, 0, 0)';
      // lis[i].style.webkitTransform = 'translate3d('+ '-1000' +'px, 0, 0)';
    };
  };
    ...
    var endHandler = function(evt){
      ...
      if(endTime - self.startTime > 300){
        ...
        if(self.offsetX > 50){
          ...
          self.goIndex('+1');
        }else if(self.offsetX < 10 && self.offsetX > -10){
          history.back(-1);
        }else{
          self.goIndex('0');
        }
