...
<head>
	...
	<style type="text/css">
		...
		.mobile1{width: 1.91rem;height: 7.46rem;background: url(/static/images/webone/mobile1.png) no-repeat;-webkit-background-size: cover;background-size: cover;left: 0.12rem;top:0.12rem;}
		...
		.mobile3{width: 1.91rem;height: 2.65rem;background: url(/static/images/webone/mobile3.png) no-repeat;-webkit-background-size: cover;background-size: cover;left: 0.12rem;top:4rem;}
		.mobile4{width: 1.9rem;height: 2.65rem;background: url(/static/images/webone/mobile4.png) no-repeat;-webkit-background-size: cover;background-size: cover;right: 0.16rem;top:6.2rem;}
		.textbox{
			width: 3.03rem;
			height: 1.53rem;
			padding-top: 0.32rem;
...
<body>
	<div class="mian">
		<div class="header"><img src="/static/images/webone/webonehead.jpg"></div>
		<div class="nav"><img src="/static/images/webone/webonenav.png"></div>
		<div class="content">
			...
			<a href="http://www.quyundong.com/d" target="_black" class="Downbuttom">下载APP体验</a>
				<ul>友情提示：
					...
					<li>4. 活动时间：2015年7月1日－14日，每日13点开抢</li>
					<li>5. 适用于趣运动广州所有在线羽毛球馆和篮球馆</li>
				</ul>
			</div>
		</div>
	</div>
