  ...
  <body data-design-width="750">
    ...
    <div class="main hide">
      <div class="order-payok-banner borderBottom1px">
        ...
        <h2><?php echo baf_CHtml::encode($message); ?></h2>

        <a id="repay" href="index" style="font-size: 16px; display: none;">重新选场</a>
      </div>
    <script>
      ...
      <?php
        //是否有跳转
        if(isset($url) && !empty($url) && isset($time) && $time > 0){
      ?>
          setTimeout("location.href='<?php echo $url;?>'",<?php echo intval($time * 1000);?>);
      <?php
        }
      ?>
    </script>
