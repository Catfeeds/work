;(function($, window, undefined) {
    ...
    Dialog.prototype = {
        ...
        create : function() {
            ...
            var divHeader = (this.settings.title==null)?'':'<div class="rDialog-header"><h3 class="layermchild2">'+this.settings.title+'</h3></div>';
        ...
        close2 : function() {
            ...
            var _this = this,
                footer = this.dialog.find('.rDialog-header');
            
            $('<button class="layermend"></button>').on("click",function() {
