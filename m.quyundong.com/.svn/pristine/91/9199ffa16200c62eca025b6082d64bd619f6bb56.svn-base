...
<div id="loading" data-lock="1" class="loading">
    ...
    <div class="main hide">
      ...
      <ul class="wechat-form forget-form">
        ...
        <li>
          <input type="password" placeholder="请输入新的密码" class="wechat-pw">
        </li>
        <li>
          <input type="password" placeholder="请再次输入新的密码" class="wechat-pw">
        </li>
      </ul>
      <ul class="login-in">
...
<script src="/themes/qu202/js/resetpw.js?v=20161111"></script>
