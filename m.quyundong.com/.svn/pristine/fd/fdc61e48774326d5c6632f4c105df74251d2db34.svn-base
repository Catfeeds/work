...
<div id="loading" data-lock="1" class="loading">
    ...
    <div class="main hide" style="min-height:90vh;">
      ...
      <ul class="wechat-form forget-form">
        ...
        <?php
        if(!empty($active_vfcode)){
        ?>
        <li style="display: block;border-bottom: 1px solid #eee;height: 30px;">
          <img src="/Captcha/index" onclick="this.src='/Captcha/index?rnd='+Math.random()" style="width:120px;float: right;" alt="验证码"/>
          <input id="checkCode" data-val="1" type="text" style="width: 50%;float: left;" placeholder="请输入验证码"/> 
...
<script type="text/javascript" src="<?php echo TEMPLATE; ?>qu/js/qucklogin.js?v=20170710258"></script>
