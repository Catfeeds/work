...
const SMS_MAX_NUM = 20;
const MANAGER_BINDING = 1;
const WEIXIN_BINDING = 2;
...
$binding.bindingInfo = function (req, res, next) {
    var venueList = req.session.managerVenueList || [];
    var type = parseInt(req.query.type) || 0;
    var venueNames = [];
    ...
    $async.waterfall([
        function (callback) {
            $redis.getValue(cacheKey, function (err, reply) {
                ...
                if (reply.send_time > 0 && reply.send_time - $moment() < SMS_VALID_TIME) {
